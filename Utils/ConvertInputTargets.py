...
def get_input_file(inputFile):
    try:
        ...
        filename = (root + '\\Sources\\' + inputFile)
...
def convinputfile(srcFileName):
    ...
    sourceInput = get_input_file("Input.json")
    relevantpart = replacePartinJson('source', inputjsonFile, sourceInput)
    #print (relevantpart)
    return
...
if __name__ == '__main__':
    ...
    convinputfile(srcFileName='Input.json')
